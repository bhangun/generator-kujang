...
export interface ApiDuaDua extends Schema.SingleType {
  collectionName: 'duas';
  info: {
    singularName: 'dua';
    pluralName: 'duas';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::dua.dua', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::dua.dua', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
...
export interface ApiProjectProject extends Schema.CollectionType {
  ...
  attributes: {
    ...
    teams: Attribute.Relation<
      ...
      'api::person.person'
    >;
    budgets: Attribute.Relation<
      'api::project.project',
      'oneToMany',
      'api::budget.budget'
    >;
    initiationDate: Attribute.Date;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
