...
function writeFiles(folder, obj, props, _) {
    ...
    if (props.isPrintComponent) {
        obj.template('entity.list.ejs', `${entityFolderName}/pages/${entityFileName}_list.dart`, obj, props)
        obj.template('entity.detail.ejs', `${entityFolderName}/pages/${entityFileName}_detail.dart`, obj, props)
        obj.template('entity.form.ejs', `${entityFolderName}/pages/${entityFileName}_form.dart`, obj, props)
        obj.template('entity.services.ejs', `${entityFolderName}/services/${entityFileName}_services.dart`, obj, props)
        obj.template('bloc.entity.store.ejs', `${entityFolderName}/store/${entityFileName}_store.dart`, obj, props)
