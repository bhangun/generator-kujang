...
const List<String> contentTypes = ["application/json","application/xml","application/x-www-form-urlencoded"];

// const String contentType = contentTypes.length > 0 ? contentTypes[0] : "application/json";
